...
const content = pillarPagesByLocale.en["roi-automation"]

export const metadata: Metadata = {
  title: content.title,
  description: content.description,
  alternates: { canonical: `https://yappix.ru${content.canonicalPath}`, languages: { "ru-RU": "https://yappix.ru/avtomatizaciya-s-roi" } },
