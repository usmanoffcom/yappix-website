...
const contactMethods = [
  ...
  },
  {
    ...
    title: "Время работы",
    value: "24/7",
    description: "Благодаря локациям в разных часовых поясах",
    href: null,
  },
]
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-4xl">
              {[
                ...
                {
                  q: "Как вы считаете экономику AI-автоматизации?",
                  a: "До старта считаем текущие трудозатраты процесса, стоимость часа команды, ожидаемое сокращение ручной работы и стоимость поддержки. На выходе получаете прогноз экономии в месяц и срок окупаемости.",
                },
                {
                  q: "Через сколько обычно окупается AI-проект?",
                  a: "В большинстве кейсов — от 3 до 5 месяцев, если процесс выбран корректно и есть измеримые метрики до/после.",
                },
                {
                  q: "Какие данные нужны от нас для точного ROI-расчёта?",
                  a: "Нужны 4 базовых параметра: объём операций в месяц, фактическое время на одну операцию, стоимость часа сотрудников и текущий SLA по процессу. Этого достаточно для первичного финансового прогноза.",
                },
              ].map((item) => (
