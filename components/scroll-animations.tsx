...
export function ScrollAnimations() {
  useEffect(() => {
    ...
    /* Не вызывать gsap.globalTimeline.clear() — убивает таймлайн Hero (HeroAnimations). */

    const main = document.querySelector("main")
    if (!main) return

    // Не трогаем узлы внутри SVG: gsap.set добавляет data-svg-origin/style на <path> и ломает гидрацию React.
