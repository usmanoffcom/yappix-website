...
const templatesByLocale = {
  ru: [
    { slug: "coinpulse-crypto", title: "CoinPulse", description: "Крипто-дашборд: Figma → Next.js за 30 минут", image: "/images/coinpulse/cover.png", stats: [{ label: "Figma → Code", value: "30 мин" }, { label: "Компоненты", value: "40+" }], tags: ["Next.js", "Tailwind", "Crypto"], link: "/shablony" },
  ...
  en: [
    { slug: "coinpulse-crypto", title: "CoinPulse", description: "Crypto dashboard: Figma → Next.js in 30 minutes", image: "/images/coinpulse/cover.png", stats: [{ label: "Figma → Code", value: "30 min" }, { label: "Components", value: "40+" }], tags: ["Next.js", "Tailwind", "Crypto"], link: "/en/templates" },
