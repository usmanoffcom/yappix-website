...
const content = {
  ...
  en: {
    badge1: "Skolkovo Residents",
    badge2: "MVP in 7 Days",
    badge3: "Money-Back Guarantee",
    h1a: "We build ",
    h1b: "complex products ",
    h1c: "faster with AI",
    desc: "Websites, mobile apps, AI solutions, SaaS and FinTech products. We use AI agents and deep coding for 7x-12x development acceleration. Offices in USA, Russia, Turkey, Serbia and Kazakhstan.",
