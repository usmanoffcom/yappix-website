...
> = {
  ru: {
    services: [
      ...
      { label: "SaaS / PaaS", href: "/uslugi/saas-paas" },
      ...
      { label: "SMM маркетинг", href: "/uslugi/smm" },
      { label: "Интеграции и API", href: "/uslugi/integracii-i-api" },
      { label: "UX/UI дизайн", href: "/uslugi/ux-ui-dizajn" },
      { label: "Аналитика данных", href: "/uslugi/analitika-dannyh" },
      { label: "Кибербезопасность", href: "/uslugi/kiberbezopasnost" },
    ],
    company: [
