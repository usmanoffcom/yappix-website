...
// Динамический импорт Spline для оптимизации
    ...
    <section className="relative min-h-[100svh] flex items-center pt-20 sm:pt-24 pb-12 overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Left Column - Content */}
          <div className="max-w-5xl lg:max-w-none mx-auto lg:mx-0 text-center lg:text-left">
          <motion.div
          ...
          <motion.p
            ...
            className="text-body-lg max-w-2xl lg:max-w-none mx-auto lg:mx-0 mb-8 sm:mb-10 text-pretty"
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8 mt-14 sm:mt-16 lg:mt-20 pt-8 sm:pt-10 border-t border-border"
          >
            {[
          ...
          {/* Right Column - Spline 3D Scene (Desktop only) */}
          <div className="hidden xl:block relative w-full h-[600px] lg:h-[700px] xl:h-[800px]">
            <motion.div
            ...
            >
              <Spline
                scene="https://prod.spline.design/YsrhGK1AHO4x8zaQ/scene.splinecode"
